...
Fase1::Fase1(Principal* p) : Fase(p)
{
  ...
  background = (*g)[3];
  entidades.setJogador(new Jogador(p, 500.0, 500.0, 160, 320, (*g)[0], Colisao(10, 10, 140, 300), 200,Animacao(sf::IntRect(0, 0, 16, 32), 0.25, "1232")));
  entidades.push(new Projetil(0, 0, 80, 80, (*g)[1], Colisao(10, 10, 60, 60), 200.0, 100.0, 1));
